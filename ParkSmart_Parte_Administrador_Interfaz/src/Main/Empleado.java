...
public class Empleado  {
    ...
    private static String nombre_Archivo = "C:\\Users\\USER\\Desktop\\Tercer_Entregable\\ParkSmart\\data\\DatosEmpleados.txt";
  public Empleado(String apellido, String nombre, String categoria) {
   ...
   private String generarIdUsuario() {
    ...
    public static void agregarEmpleado(Empleado empleado) {
       ...
       public static void crearArchivoConEmpleadosPorDefecto() {
        File archivo = new File(nombre_Archivo);
        if (!archivo.exists()) {
            try {
                if (archivo.createNewFile()) {
                    System.out.println("Archivo creado: " + nombre_Archivo);
                }
            } catch (IOException e) {
                e.printStackTrace();
            }
            ...
            Empleado empleado1 = new Empleado("Perez", "Juan", "Administrador");
            Empleado empleado2 = new Empleado("Garcia", "Maria", "Coordinador");
            Empleado empleado3 = new Empleado("Lopez", "Carlos", "Observador");

            agregarEmpleado(empleado1);
            agregarEmpleado(empleado2);
            agregarEmpleado(empleado3);

            System.out.println("Empleados por defecto añadidos.");
        } else {
