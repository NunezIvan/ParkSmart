...
public class Administradores {
    ...
    static {
        ...
        usuarios.add(new Administrador("admin", "123", "12367234"));
    }
    ...
    //Despues de iniciar sesion se va al menu estacionamiento, solo es posible con el usuario y contraseña adecuados
    ...
    //La opcion 5 es externa del administrador
    private static void mostrarMenuEstacionamiento(Scanner scanner, Estacionamiento estacionamiento, PerfilUsuario perfil, Administrador usuarioActual) {
        ...
        while (continuar) {
            ...
            System.out.println("5. Registrar vehiculo");//Interfaz del usuario
