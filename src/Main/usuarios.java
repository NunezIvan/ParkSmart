...
public class usuarios {
    ...
    static {
        ...
        usuarios.add(new usuario("admin", "123", "12367845"));
    }
    ...
    private static void mostrarMenuEstacionamiento(Scanner scanner, Estacionamiento estacionamiento, PerfilUsuario perfil, usuario usuarioActual) {
